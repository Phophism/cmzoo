						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-header">
									...
									data-offstyle="info" onchange="change();" <?php if(!isset($cageReceive)) echo " " ; else echo " checked"; ?> />
									<?php
										...
										<div class="col-lg-12 ">
											<div class="btn-group btn-group-toggle" data-toggle="buttons">
												<label class="btn btn-primary <?php if($period == 1) echo " active ";?>">
													<input type="radio" name="options" id="option1" autocomplete="off" value="1" onchange="change();" <?php if($period == 1) echo " checked ";?> > Day
												</label>
												<label class="btn btn-primary <?php if($period == 2) echo " active ";?>">
													<input type="radio" name="options" id="option2" autocomplete="off" value="2" onchange="change();" <?php if($period == 2) echo " checked ";?> > Week
												</label>
												<label class="btn btn-primary <?php if($period == 3) echo " active ";?>">
													<input type="radio" name="options" id="option3" autocomplete="off" value="3" onchange="change();" <?php if($period == 3) echo " checked ";?> > Month
												</label>
											</div>
										</div>
										<div class="col-lg-12">
